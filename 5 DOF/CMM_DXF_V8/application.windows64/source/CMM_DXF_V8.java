...
public class CMM_DXF_V8 extends PApplet {
...
//  2D export.
//  Original coding by (F)DZL 2015   
//  Modifications and additional features by Bryan Lord 2019
//============================================================
//============================================================
...
class pointer
{
  ...
  pointer(PApplet p, int index)
  {
    ...
    String[] ports = Serial.list();
    if(ports.length>0){
      myPort =new Serial(p, ports[ports.length-1], 19200); // Comment out for offline testing
      myPort.setDTR(true);
    }*/
    active=true;
  }
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "CMM_DXF_V8" };
    if (passedArgs != null) {
